...
class ParametersWindow(tk.Toplevel):
    ...
    def _build_ui(self):
        ...
        for path, node, display in fields_to_render:
            ...
            tk_var.trace_add("write", lambda *_, v=tk_var: self._on_var_changed(v))
            rows += 1
    ...
    def _on_var_changed(self, tk_var: tk.StringVar):
    ...
    def _resize_to_content(self):
        ...
        # Clamp dimensions
        width = max(520, min(req_w + 60, 900))    # limit width
    ...
    def _apply_and_save(self):
        ...
        try:
            ...
            messagebox.showinfo("Success", "Parameters saved to config.json.")
        except Exception as e:
            messagebox.showerror("Error", f"Failed to save config: {e}")

    def _run(self):
        # Apply edits and save to config.json (represents 'Run' action placeholder)
